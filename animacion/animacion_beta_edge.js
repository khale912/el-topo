   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid2085", tween: [ "style", "${_llama2}", "-moz-transform-origin", [50,0], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,0]}], position: 17, duration: 0, easing: "easeInQuart" },
            { id: "eid2086", tween: [ "style", "${_llama2}", "-ms-transform-origin", [50,0], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,0]}], position: 17, duration: 0, easing: "easeInQuart" },
            { id: "eid2087", tween: [ "style", "${_llama2}", "msTransformOrigin", [50,0], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,0]}], position: 17, duration: 0, easing: "easeInQuart" },
            { id: "eid2088", tween: [ "style", "${_llama2}", "-o-transform-origin", [50,0], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,0]}], position: 17, duration: 0, easing: "easeInQuart" },
