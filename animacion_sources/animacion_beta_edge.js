...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'logo-el-topo',
            type:'image',
            rect:['127px','77px','300px','419px','auto','auto'],
            fill:["rgba(0,0,0,0)",'logo-el-topo.png','0px','0px']
         }],
         symbolInstances: [
         {
            id:'rectangulo',
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid2126", tween: [ "style", "${_logo-el-topo}", "top", '77px', { fromValue: '-430px'}], position: 1672, duration: 265, easing: "easeOutBack" },
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid2368", tween: [ "style", "${_llama2}", "-moz-transform-origin", [50,0], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,0]}], position: 17, duration: 0, easing: "easeInQuart" },
            { id: "eid2369", tween: [ "style", "${_llama2}", "-ms-transform-origin", [50,0], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,0]}], position: 17, duration: 0, easing: "easeInQuart" },
            { id: "eid2370", tween: [ "style", "${_llama2}", "msTransformOrigin", [50,0], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,0]}], position: 17, duration: 0, easing: "easeInQuart" },
            { id: "eid2371", tween: [ "style", "${_llama2}", "-o-transform-origin", [50,0], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,0]}], position: 17, duration: 0, easing: "easeInQuart" },
