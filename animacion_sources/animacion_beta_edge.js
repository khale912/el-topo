   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid2276", tween: [ "style", "${_llama2}", "-moz-transform-origin", [50,0], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,0]}], position: 17, duration: 0, easing: "easeInQuart" },
            { id: "eid2277", tween: [ "style", "${_llama2}", "-ms-transform-origin", [50,0], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,0]}], position: 17, duration: 0, easing: "easeInQuart" },
            { id: "eid2278", tween: [ "style", "${_llama2}", "msTransformOrigin", [50,0], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,0]}], position: 17, duration: 0, easing: "easeInQuart" },
            { id: "eid2279", tween: [ "style", "${_llama2}", "-o-transform-origin", [50,0], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,0]}], position: 17, duration: 0, easing: "easeInQuart" },
